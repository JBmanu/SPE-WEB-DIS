...
| PlayerLoggedIn              | Domain-Event          | Evento che indica che il Player ha effettuato un accesso al sistema; ricevuto dal player-identity-context e usato per aggiornare contatori di Achievement legati alla frequenza di accesso.                                           |
| PlayerRegistered            | Domain-Event          | Evento che indica che un nuovo Player è stato registrato nel sistema; ricevuto dal player-identity-context e usato per creare il PlayerProgress iniziale.                                                                             |
| FriendshipAccepted          | Domain-Event          | Evento che indica che una richiesta di amicizia è stata accettata tra due Player; ricevuto dal player-identity-context e usato per aggiornare contatori di Achievement legati alle amicizie.                                          |
| CustomDeckCreated           | Domain-Event          | Evento che indica che un nuovo Deck personalizzato è stato creato nel DeckWorkshop; ricevuto dal deck-workshop-context e usato per aggiornare il DeckWorkshopRecord e valutare gli Achievement legati alla creazione di deck.         |
| MatchEnded                  | Domain-Event          | Evento che indica che un Match si è concluso nel match-context; ricevuto dal match-context e usato per triggerare la MatchResultProjection, aggiornare il MatchRecord e valutare Achievement/Badge legati ai risultati delle partite. |
