...
| Term            | Block-Type     | Motivation                                                                                                                                                                                                                       |
|-----------------|----------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| MatchFactory    | Factory        | crea Match - logica include inizializzazione DrawPile (shuffle delle carte da GameSettings), distribuzione Hand iniziale ai giocatori, impostazione SequenceTurn dall'ordine dei JoinedPlayer ricevuti da MatchStarted           |
| MatchRepository | Repository     | gestisce Match, recuperato per ID                                                                                                                                                                                                |
|                 |                |                                                                                                                                                                                                                                  |
| Match           | Aggregate-Root | controlla DrawPile, DiscardPile, lista ActivePlayer, lista WatcherPlayer, SequenceTurn — garantisce che il turno corrente appartenga sempre a un ActivePlayer valido e che la partita termini quando rimane un solo ActivePlayer |
| DrawPile        | Value-Object   | sequenza ordinata di carte da pescare - sostituita intera ad ogni modifica (draw, shuffle, alter-the-future, defuse che rimette la bomba)                                                                                        |
| DiscardPile     | Value-Object   | sequenza di carte già giocate - sostituita intera ad ogni carta aggiunta                                                                                                                                                         |
| SequenceTurn    | Value-Object   | ordine circolare degli ActivePlayer che devono giocare - sostituito intero ad ogni modifica (skip, attack che aggiunge turni extra)                                                                                              |
| Hand            | Value-Object   | insieme delle carte in possesso di un ActivePlayer - sostituita intera ad ogni modifica (carta giocata, carta pescata, carta rubata da favor)                                                                                    |
...
| WatcherPlayer   | Value-Object   | riferimento a un osservatore della partita (player ID + nickname + canReact) - canReact true per giocatori esplosi, false per osservatori esterni; sostituito intero al cambio                                                   |
| Reaction        | Value-Object   | emoji-reaction inviata da un ActivePlayer o WatcherPlayer con canReact true - contiene tipo emoji e player ID mittente; temporanea, non persistita, trasportata dentro ReactionSent                                              |
...
| Turn            | Entity         | turno singolo di un ActivePlayer - ha numero progressivo, timer, stato (active/completed); completato quando il giocatore pesca (pass) o usa una carta categoria A; ha identità propria                                          |
|                 |                |                                                                                                                                                                                                                                  |
| MatchStarted    | Domain-Event   | ricevuto da pregame-lobby-context - inizializza Match con GameSettings e lista JoinedPlayer                                                                                                                                      |
| MatchEnded      | Domain-Event   | prodotto quando rimane un solo ActivePlayer - consumato da scoreboard-context, quest-context, match-replay-context, game-observatory-context                                                                                     |
|                 |                |                                                                                                                                                                                                                                  |
| CardDrawn       | Domain-Event   | prodotto quando un ActivePlayer pesca dal DrawPile - se la carta è una Bomb triggera BombDrawn, altrimenti la carta entra nella Hand                                                                                             |
| BombDrawn       | Domain-Event   | prodotto quando viene pescata una Bomb - Match aspetta la risposta del player (usa Defuse o esplode)                                                                                                                             |
| BombDefused     | Domain-Event   | prodotto quando l'ActivePlayer usa un Defuse in risposta a BombDrawn - la Bomb viene rimessa nel DrawPile nella posizione scelta dal player                                                                                      |
| CardActivated   | Domain-Event   | prodotto quando un ActivePlayer gioca una carta dalla Hand - porta il tipo di carta e i parametri per la risoluzione                                                                                                             |
|                 |                |                                                                                                                                                                                                                                  |
| GameWatched     | Domain-Event   | ricevuto da lobby-browser-context - aggiunge WatcherPlayer con canReact false                                                                                                                                                    |
| *PlayerWatching*  | Domain-Event   | prodotto quando un giocatore esploso diventa WatcherPlayer - notifica tutti i client della partita                                                                                                                               |
| PlayerLeaved    | Domain-Event   | prodotto quando un ActivePlayer abbandona volontariamente - Match verifica se rimangono almeno 2 ActivePlayer, altrimenti produce MatchEnded                                                                                     |
| PlayerExploded  | Domain-Event   | prodotto quando la Bomb esplode senza Defuse - ActivePlayer passa a exploded, diventa WatcherPlayer con canReact true                                                                                                            |
|                 |                |                                                                                                                                                                                                                                  |
| TurnStarted     | Domain-Event   | prodotto quando inizia il turno di un ActivePlayer - avvia il timer lato server                                                                                                                                                  |
| TurnEnded       | Domain-Event   | prodotto quando un turno si conclude (pass, carta categoria A giocata, o timer scaduto) - Match aggiorna SequenceTurn e produce TurnStarted per il prossimo ActivePlayer                                                         |
|                 |                |                                                                                                                                                                                                                                  |
